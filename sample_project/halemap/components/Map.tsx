                      ...
                      <div className="flex flex-col items-center">
                        {reportFile ? (
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-xs text-indigo-600 font-medium truncate max-w-[180px]">{reportFile.name}</span>
                          </div>
                        ) : (
                          <>
                            ...
                            <span className="text-xs text-indigo-600 font-bold bg-indigo-50 px-2 py-1 rounded">写真を追加する</span>
                          </>
                        )}
                      </div>
                      <input
                ...
                <div className="flex gap-2 mt-2">
                  ...
                  {spot.status === 'vacant' ? (
                    <button
                      ...
                      className="flex-1 bg-indigo-600 text-white text-xs py-2 rounded hover:bg-indigo-700"
                    >
                      ポスターを貼る
                    </button>
                  ) : (
